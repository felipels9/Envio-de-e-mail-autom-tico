...
Para usar o script de forma correta, basta editar as variáveis  msg['Subject'] = 'Reunião Extraordinária', 'msg' ['From'] com o e-mail do remetente e 'msg' ['To'] com os endereços de e-mail dos destinatários no PyCharm. É necessário também, que a variável 'Inclua sua senha do aplicativo aqui' seja substituida pela senha de app gerada.
